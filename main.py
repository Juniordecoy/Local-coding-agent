...
from command_handlers import (
    ...
    review_validator_warning_command, validate_draft_command, draft_quiz_from_reference_command,
)
...
ARGUMENT_COMMANDS = {
    ...
    "draft quiz from reference ": draft_quiz_from_reference_command, "draft ai page ": draft_ai_page_command, "draft ai html ": draft_ai_html_command,
    "review draft ": review_draft_command, "review html structure ": review_html_structure_command, "review validator warning ": review_validator_warning_command,
    "review validator ": review_validator_command, "validate draft ": validate_draft_command,
}
